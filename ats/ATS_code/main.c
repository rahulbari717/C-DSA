...
void print_welcome_message()
{
    printf("\n");
    printf("******************************************************************************\n");
    printf("*                        ATS RESUME Software by Rahul B.                     *\n");
    printf("******************************************************************************\n");
...
char *get_resume_path()
{
    ...
    // Automatically add ".pdf" if not found
    if (!strstr(resume_path, ".pdf"))
    {
        printf("Note: '.pdf' extension not found. Appending it automatically.\n");
        strncat(resume_path, ".pdf", MAX_PATH_LENGTH - strlen(resume_path) - 1);
    }
